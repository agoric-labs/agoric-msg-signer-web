...
const butttonThemeStyles = {
  dark: "text-white bg-amaranth-600 focus-visible:outline-amaranth-600 hover:opacity-80",
  light:
    "text-black bg-amaranth-200 focus-visible:outline-amaranth-200 hover:bg-amaranth-300",
  white:
