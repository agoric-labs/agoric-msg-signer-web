            ...
            <div className="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4 sm:py-6">
              ...
              <div className="mt-2 sm:col-span-3 sm:mt-0">
                <input
                  ...
                  id="issue"
                  placeholder=""
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-amaranth-600 sm:max-w-lg sm:text-sm sm:leading-6"
                />
            ...
            <div className="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4 sm:py-6">
              ...
              <div className="mt-2 sm:col-span-3 sm:mt-0">
                <input
                  ...
                  min="1"
                  // placeholder="0"
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-amaranth-600 sm:max-w-xs sm:text-sm sm:leading-6"
                />
                <p className="mt-3 text-xs leading-6 text-gray-600">
